...
<div class="profile-container">
  ...
  {#if data.user}
    ...
    <form method="POST" action="?/updateProfile" use:enhance={submitForm} class="profile-form">
      <label for="username">Username:</label>
      <input type="text" id="username" name="username" bind:value={profileFormData.username} required />

      <label for="full_name">Full Name:</label>
      <input type="text" id="full_name" name="full_name" bind:value={profileFormData.full_name} />

      <label for="avatar_url">Avatar URL:</label>
      <input type="url" id="avatar_url" name="avatar_url" bind:value={profileFormData.avatar_url} />
