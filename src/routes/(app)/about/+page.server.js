		...
		try {
			...
			let html = `
				<div style="font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #333333;">
						<h3 style="color: #000000; font-size: 20px; margin-bottom: 15px;">New message from Cariari.Community Contact Form</h3>
			...
			const message = {
				...
				subject: `Cariari.Community message from ${name}, ${email}`,
				text: body,
				html: html,
			};
